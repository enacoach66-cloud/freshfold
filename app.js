(function () {
  ...
  const BUSINESS = Object.freeze({ name: "FreshFold Laundry", tagline: "Fresh. Clean. Delivered.", phone: "0793656348", terms: "Prices may change after inspection for heavily stained, oversized, or special fabric items." });
  ...
  function printQuote(e) { if (!requireRows()) return; withLoading(e?.currentTarget, "Preparing…", () => { renderPreview(); window.print(); toast("Print dialog opened."); }); }
